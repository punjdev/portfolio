    ...
    return (
        ...
        flex-col py-20'>
            <div className='text-center'>
                ...
                <a href="#projects" className='inline-block px-8 py-3 border border-transparent text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700 md:text-md'> BUTTON</a>           
            </div>
        </div>
    )
}
